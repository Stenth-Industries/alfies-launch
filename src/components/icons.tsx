...
export function StoreIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M21 7 19.5 2h-15L3 7v2a3 3 0 0 0 1 2.24V21a1 1 0 0 0 1 1h6v-6h2v6h6a1 1 0 0 0 1-1V11.24A3 3 0 0 0 21 9Zm-4 14h-2v-6a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v6H7v-9.05a3 3 0 0 0 2.5-1.2 3 3 0 0 0 5 0 3 3 0 0 0 2.5 1.2Z" />
    </svg>
  );
}
